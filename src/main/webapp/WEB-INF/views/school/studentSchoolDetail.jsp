...
<div class="header">
      <div class="back"><a onclick="history.back()"><i
        ...
        <div class="container">
            <div>
                <img src="<c:url value='/resources/images/${school.name}.png' />" alt="School Logo" />
                ...
                <p><strong>Studio Available:</strong> ${school.studio ? "Yes" : "No"}</p>
                <p><strong>School Recording Facility:</strong> ${school.schoolRecording ? "Yes" : "No"}</p>
                <p><strong>Upload to YouTube:</strong> ${school.uploadYoutube ? "Yes" : "No"}</p>
                <p><strong>Recording Capability:</strong> ${school.recording ? "Yes" : "No"}</p>
                <p><strong>Collaboration Enabled:</strong> ${school.collaborate ? "Yes" : "No"}</p>
                <p><strong>Green Screen Available:</strong> ${school.greenscreen ? "Yes" : "No"}</p>
