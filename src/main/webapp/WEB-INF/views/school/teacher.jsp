  ...
  <body>
    ...
    <div class="content">
      <div class="header">
        <h1>School List</h1>
        <button
          onclick="window.location.href='/TVPSSHub/school/teacher/schoolDetail?name=Sekolah Tinggi Segamat'"
        >
          My School
        </button>
      </div>
            ...
            <tbody>
              <c:forEach var="school" items="${schools}">
                <tr>
                  <td>
                    <a
                      href="/TVPSSHub/school/teacher/schoolDetail?name=${school.name}"
                      >${school.name}</a
                    >
                  </td>
