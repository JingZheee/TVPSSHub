...
<body>
	...
	<div class="content">
		<div class="header">
			...
			<c:if test="${school.name == 'Sekolah Tinggi Segamat'}">
				<button
					onclick="window.location.href='/TVPSSHub/school/teacher/editSchoolDetail?name=${school.name}'">
					Edit Profile</button>
			</c:if>
		</div>
		<div class="container">
			<div>
				...
				<p>
					<strong>Brand:</strong> ${school.brand}
				</p>
				<p>
					<strong>Studio Available:</strong> ${school.studio ? "Yes" : "No"}
				</p>
				<p>
					<strong>School Recording Facility:</strong>
					${school.schoolRecording
            ? "Yes" : "No"}
				</p>
				<p>
