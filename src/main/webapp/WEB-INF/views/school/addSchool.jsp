  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="form-container">
        <form method="post" action="/TVPSSHub/school/teacher/addSchool">
          <div>
            <p>School Name:</p>
            ...
            <input type="checkbox" name="studio" ${school.studio ? "checked" :
            ""} />
            ...
            <input type="checkbox" name="uploadYoutube" ${school.uploadYoutube ?
            "checked" : ""} />

            <p>Recording Capability:</p>
            <input type="checkbox" name="recording" ${school.recording ?
            "checked" : ""} />

            <p>Collaboration Enabled:</p>
            <input type="checkbox" name="collaborate" ${school.collaborate ?
            "checked" : ""} />

            <p>Green Screen Available:</p>
            <input type="checkbox" name="greenscreen" ${school.greenscreen ?
            "checked" : ""} />
