...
public class UserDAO {
    ...
    public List<UserViewModel> findUsersBySchool(String schoolName) {
        Session session = HibernateCF.getSessionFactory().openSession();
        try {
            Query<UserViewModel> query = session.createQuery("FROM UserViewModel WHERE lower(school) = :schoolName", UserViewModel.class);
    ...
    public UserViewModel findUserByEmail(String email) {
        Session session = HibernateCF.getSessionFactory().openSession();
        try {
            Query<UserViewModel> query = session.createQuery("FROM UserViewModel WHERE email = :email", UserViewModel.class);
